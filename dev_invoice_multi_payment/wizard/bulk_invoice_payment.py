...
class bulk_inv_payment(models.TransientModel):
    ...
    def default_get(self, fields):
        ...
        if inv_type in ("out_invoice", "in_refund"):
            res.update({"payment_type": "inbound"})
        else:
            res.update({"payment_type": "outbound"})
    ...
    payment_type = fields.Selection(
        [("outbound", "Enviar"), ("inbound", "Recibir"), ("transfer", "Transferencia")],
        string="Payment Type",
        required="1",
    )
    ...
    partner_type = fields.Selection(
        [("customer", "Cliente"), ("supplier", "Proveedor")], string="Partner Type"
    )
    ...
    # One2many('account.payment.method.line','bulk_payment_id',string='Payment Method')
    ...
    def process_payment(self):
        ...
        for res in result:
            ...
            pay_val = {
                ...
                and self.payment_method_line_id.id
                or False,
                "state": "draft",
