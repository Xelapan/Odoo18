...
class AsistenteReporteCompras(models.TransientModel):
    ...
    def print_report(self):
        ...
        return (
            self.env.ref("l10n_gt_extra.action_reporte_compras")
    ...
    def print_report_excel(self):
        for w in self:
            ...
            hoja.write(
                y, 11, totales["importacion"]["neto"] + totales["importacion"]["exento"]
            )
            ...
            hoja.write(
                ...
                13,
                totales["compra"]["iva"]
                + totales["servicio"]["iva"]
                + totales["combustible"]["iva"]
                + totales["importacion"]["iva"]
                + totales["pequeño"]["iva"],
            )
            hoja.write(
                y,
                14,
                totales["compra"]["total"]
                + totales["servicio"]["total"]
                + totales["combustible"]["total"]
                + totales["importacion"]["total"]
                + totales["pequeño"]["total"],
            )
            ...
            hoja.write(
                y,
                3,
                totales["compra"]["exento"]
                + totales["servicio"]["exento"]
                + totales["combustible"]["exento"]
                + totales["importacion"]["exento"]
                + totales["pequeño"]["exento"],
            )
            hoja.write(
                y,
                4,
                totales["compra"]["neto"]
                + totales["servicio"]["neto"]
                + totales["combustible"]["neto"]
                + totales["importacion"]["neto"]
                + totales["pequeño"]["neto"],
            )
            hoja.write(
                y,
                5,
