...
class HrPayslipPrestaciones(models.Model):
    ...
    id_employee_id = fields.Integer(
        string="IdE", readonly=True, related="employee_id.id"
    )
    ...
    date_start_contract = fields.Date(
        string="Inicio de Contrato",
        readonly=True,
        related="employee_id.contract_id.date_start",
    )
    date_end_contract = fields.Date(
        string="Fin de Contrato",
        readonly=True,
        related="employee_id.contract_id.date_end",
    )
    contract_state = fields.Selection(
        ...
        readonly=True,
        related="employee_id.contract_id.state",
    )
